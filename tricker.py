...
def ud():
    os.system('clear')
    print(logo)
    print(' [1] FOLLOW ON FACEBOOK')
    print(' [2] EXIT')
    opt = input('\n   Choose option >>> ')
    if opt == '1':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100017784376294')
        FD()
        return None
...
def FD():
    ...
    if opt == '1':
        os.system('xdg-open https://youtube.com/@saurabhsinghtechnical1216?si=hatmnQtS5okPANve')
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-open https://www.facebook.com/profile.php?id=100007994598695')
        return None
    if None == '3':
...
\033[1;37m================= \33[32;45mSAURABH\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mSAURABH\33[0;m\033[1;32m && \033[1;33mTHAKUR\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m SAURABH XD
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mTEAM- ALONE BOY 
...
\033[1;37m================= \33[32;45mSAURABH\33[0;m =====================
       ...
       \33[37;41m\t WELLCOME TO SAURABH XD TOOL\33[0;m
...
def i():
    ...
    print('\033[1;32m============================================')
    print('\033[1;36m     \t     INDIA CODES\n     \033[1;33m91778, \033[1;33m91930 ,\033[1;33m91904 ,\033[1;33m91730  ...\033[0;97m')
    print('\033[1;32m============================================')
